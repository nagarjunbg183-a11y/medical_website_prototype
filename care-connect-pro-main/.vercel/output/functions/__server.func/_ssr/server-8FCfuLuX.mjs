import "../_runtime.mjs";
import { at as require_react } from "../_libs/@hookform/resolvers+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Dm07cSpl.mjs");
